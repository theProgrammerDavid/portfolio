...
export function buildProject(title: string, description: string, document_url: string): Project {
    return {
...
export function buildAchievement(title: string, document_url: string): Achievement {
    return {
